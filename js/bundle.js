...
function calc () {
   ...
   function getStaticInformation (parentSelector, activeClass) {
      ...
      document.querySelector(parentSelector).addEventListener('click', (e)=> {
         ...
         if(e.target.classList.contains('calculating__choose-item'||0)){
...
function forms (formSelector,modalTimerId) {
   ...
   function showThanksModal(massage) {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_0__.open)('.modal',modalTimerId);
...
async function getResource (url)  {
   ...
   if (!res.ok) {
      throw new Error(`Could not fetch ${url}, status: ${res.status}`); // код ошибки запроса 
   }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider ({container,slide,nextArrow,prevArrow,totalCounter,currentCounter,wrapper,fieled }){
   //Slider
   const slides = document.querySelectorAll(slide),
      ...
      slidesField = document.querySelector(fieled),
...
document.addEventListener('DOMContentLoaded', () => {
   ...
   //ES6
      ...
      const modalTimerId = setTimeout(()=> (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.open)('.modal', modalTimerId), 50000);

      (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item','.tabcontent','.tabheader__items','tabheader__item_active');
      (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]','.modal', modalTimerId);
      (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer','2023-09-15');
